...
class Application(ResourceBase):
    ...
    def get_load_balancers(self, query):
        ...
        return self.get_children(self.dto['loadBalancers'], query, headers, LoadBalancer)
    ...
    def get_pool_members(self, query):
        ...
        return self.get_children(self.dto['members'],
    ...
    def get_pool_statistics(self, query):
        ...
        return self.get_children(self.dto['poolStatistic'],
